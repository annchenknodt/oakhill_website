...
def saved(request):
	return render(request, 'input_rental.html',{'form':form})
...
def edit(request,analysis_id):
	...
	return render(request, 'input_rental.html',{'form':form})
	# return render(request, 'input_rental.html',{'form_desc':form_desc,'form_fin':form_fin,'form_inc':form_inc,'form_fix_ex':form_fix_ex,'form_var_ex':form_var_ex,'form_future':form_future})
